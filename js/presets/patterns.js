...
define('presets/patterns', function () {
    ...
    var patterns = [
        ...
        'background: linear-gradient(26deg, black 25%, transparent 25%) 100px 0, linear-gradient(-26deg, transparent 75%, black 75%); background-size: 100px 100px, 100px 100px;'
    ];
