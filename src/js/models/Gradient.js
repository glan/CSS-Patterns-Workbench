  ...
  radialCSS: function (adjustments, html) {
    ...
    if (html) {
      ...
      if (this.get('shape')) {
        ...
        css += '<span class="value">' + this.get('width') + '</span> <span class="value">' + this.get('height') + '</span> ';
      }

      css += 'at ' + this.get('position').split(' ').map(function (pos) { return '<span class="value">' + pos + '</span>' }).join(' ') + ', ';
      ...
      if (this.get('shape')) {
        ...
        css += this.get('width') + ' ' + this.get('height') + ' ';
      }
      css += ' at ' + this.get('position') + ', ';
...
module.exports = Backbone.Model.extend(gradient);
