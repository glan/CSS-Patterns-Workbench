...
var _ = require('underscore'),
    ...
    patterns = require('../presets/patterns');
...
var layerListTools = {
    handleEvent : function(event) {
        var domLayer = $(event.target).closest('.layer'),
            orignalId,
            newLayers,
            layer = this.layerList.layers.get({ cid: domLayer.attr('data-id') }),
        ...
        if (this.layerList.selectedLayers && event.type === 'click' && event.target.className === 'remove') {
            ...
            this.layerList.selectedLayers.forEach(function(layer) {
                ...
                newLayer.attributes.name = layer.attributes.name + ' copy'
